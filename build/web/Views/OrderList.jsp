                                ...
                                <div class="filter_group_content filter-size s-filter" id="status-filter">
                                    <ul class="check-box-list clearfix">
                                        <li>
                                            ...
                                            <li>
                                                <input type="checkbox" name="status-filter" value="Confirmed"
                                                <c:if test="${not empty selectStatusList and selectStatusList.contains('Confirmed')}">checked</c:if>
                                                    style="display: inline-block" /> Confirmed
                                            </li>
                                            <li>
                                                <input type="checkbox" name="status-filter" value="Cancled"
                                                <c:if test="${not empty selectStatusList and selectStatusList.contains('Cancled')}">checked</c:if>
                                                    style="display: inline-block" /> Cancled
                                            </li>
                                        </ul>
                                    </div>
                                </div>
